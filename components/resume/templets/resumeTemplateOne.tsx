...
const ResumeTemplateOne: React.FC<ResumeTemplateOneProps> = ({
  ...
  return (
    ...
    >
      <div className="grid grid-cols-12 min-h-[1100px] bg-container shadow-lg text-on-container">
        {/* LEFT COLUMN */}
        <div
          className="col-span-4 h-full flex flex-col p-4 text-on-primary"
        ...
        >
          ...
          <div className="w-32 h-32 rounded-full overflow-hidden mx-auto bg-gray-300">
            {profileInfo?.profileImageUrl ? (
              ...
              <div className="flex items-center justify-center h-full text-on-primary text-sm">
                No Image
              </div>
            )}
          </div>
...
const Empty = ({ label }: { label: string }) => (
  <p className="text-xs italic text-on-muted">{label}</p>
);
